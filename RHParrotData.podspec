#
#  Be sure to run `pod spec lint RHParrotData.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of RHParrotData in Markdown format.
  ...
  # Or just: s.author    = "Hanran Liu"
  # s.authors            = { "Hanran Liu" => "18622218653@163.com" }
  # s.social_media_url   = "http://twitter.com/Hanran Liu"
